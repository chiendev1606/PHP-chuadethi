<!-- ---- Part 2: Whrite registration form---- -->

<?php
// ghep file validate_register.php de validate va xu ly du lieu
// tat ca cac bien deu chua trong file validate_register.php
...
<html lang="en">
  ...
  <div class="form-container">
    <h3 class="title">CREATE YOUR ACCOUNT</h2>
  <form action="#" method="POST">
  <div class="form-group">
    <label for="">UserName</label>

    <!-- hien thi User_Name sau khi xu ly-->
  ...
  <div class="form-group">
    ...
    <!-- hien thi Phone_Number sau khi xu ly--->
    <input type="number" class="form-control" name="Phone_Number" value="<?php echo $Phone_Number ?>" required>
  ...
  <div class="form-group">
   ...
   <a href="../Part4_reset_pw/reset_pw.php"><button type="button" class="btn btn-secondary">Reset password</button></a>
  </div>
  </div>
